...
CrateDB Cloud. The first step is always to :ref:`sign up <sign-up>`.
...
Additionally, CrateDB Cloud currently supports subscribing via Software as
a Service (SaaS) offerings on two different cloud provider marketplaces,
Microsoft's Azure Marketplace and Amazon's AWS Marketplace. Corresponding
tutorials also feature a full walkthrough for the signup and deployment
process for each of these under the header of :ref:`deploying via the
Marketplace offers <cluster-deployment-marketplace>`.
